 ...
 *
 * @package    Wp_Ssawc
 * @subpackage Wp_Ssawc/admin/partials
 */
?>

<div id="woocommerce-settings" class="wrap metabox-holder columns-2 wp_cbf-metaboxes hidden">

	<h2><?php esc_attr_e( 'Woocommerce API Settings', $this->plugin_name ); ?></h2>
     <br/>
     ...
     <table class="form-table">
		...
		<label for="<?php echo $this->plugin_name;?>-consumer_key">
			<span><?php esc_attr_e('Consumer Key', $this->plugin_name);?></span>
     			...
     			<td class="forminp">
					<input type="text" class="regular-text" id="<?php echo $this->plugin_name;?>-consumer_key" name="<?php echo $this->plugin_name;?>[consumer_key]" value="<?php if(!empty($consumer_key)) esc_attr_e($consumer_key, $this->plugin_name);?>" placeholder="<?php esc_attr_e(' ', $this->plugin_name);?>" />
     			</td>
     		</tr>
     		<tr valign="top">
     			<th scope="row" class="titledesc">
		...
		<label for="<?php echo $this->plugin_name;?>-consumer_secret">
			<span><?php esc_attr_e('Consumer Secret', $this->plugin_name);?></span>
     			...
     			<td class="forminp">
						<input type="text" class="regular-text" id="<?php echo $this->plugin_name;?>-consumer_secret" name="<?php echo $this->plugin_name;?>[consumer_secret]" value="<?php if(!empty($consumer_secret)) esc_attr_e($consumer_secret, $this->plugin_name);?>" placeholder="<?php esc_attr_e(' ', $this->plugin_name);?>" />
     			</td>
     		</tr>
     	</tbody>
     </table>
