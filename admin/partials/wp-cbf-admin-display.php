...
<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
            <a href="#products-settings" class="nav-tab nav-tab-active"><?php _e('Product Settings', $this->plugin_name);?></a>
            <a href="#woocommerce-settings" class="nav-tab"><?php _e('WooCommerce Settings', $this->plugin_name);?></a>
	...
	<form method="post" name="cleanup_options" action="options.php">
      ...
      $smtp_password = $options['smtp_password'];
		 ...
		 // Include tabs partials
			require_once('wp-cbf-products-settings.php');
			require_once('wp-cbf-woocommerce-settings.php');
